...
int main()
{
    ...
    do{
        ...
        printf("Seja Bem-Vindo(a), escolha uma das opções do menu\n"
        	"0- Sair do programa.\n"
           	"1- Digite um número para saber se ele é par/impar.\n"
        ...
        switch(numDigitado){
            ...
            case 2 :{
                ...
                printf("O resultado da potência em notação científica é: %.3E.", resultado);
                break;
            }
            ...
            case 10 :{
                ...
                printf("\n Matrícula em hexadecimal: %X. Seu nome é %s", matricula, nome);
                break;
            }
